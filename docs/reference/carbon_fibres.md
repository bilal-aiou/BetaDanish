...
#> Warning: Parameters a, b, c, and k must be strictly positive.
#> Warning: Parameters a, b, c, and k must be strictly positive.
#> Warning: pbeta(*, log.p=TRUE) -> bpser(a=374115, b=13.5121, x=0.958591,...) underflow to -Inf
#> Warning: pbeta(*, log.p=TRUE) -> bpser(a=374115, b=13.5121, x=0.976982,...) underflow to -Inf
#> Warning: pbeta(*, log.p=TRUE) -> bpser(a=374115, b=13.5121, x=0.926549,...) underflow to -Inf
